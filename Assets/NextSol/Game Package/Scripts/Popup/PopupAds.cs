...
{
    public static PopupAds Instance;
    ...
    public void GetIncomeForMap()
    {
        ...
        income += DataManager.Instance.listUpgradeIncome[DataManager.Instance.listLevelEarning[3 * LoadingManager.Instance.currentMap]][3 * LoadingManager.Instance.currentMap];
    ...
    public float GetFormulaIncome(float income, int worker, float speed)
    {
        return (income * worker * speed) / 16;
    }
    ...
    public void x2SpeedTest()
    {
        AdsManager.Instance.ActivateBoosterSpeedTest();
    }

    public void x2IncomeBooster()
    {
    ...
    public void WatchInvestorSucess()
    {
        GameUIManager.Instance.AddMoney(GetMaxIncome() * 5);
    }
    ...
    public float GetMaxIncome()
    {
        ...
        if (DataManager.Instance.listUpgradeIncome[DataManager.Instance.listLevelEarning[3 * LoadingManager.Instance.currentMap]][3 * LoadingManager.Instance.currentMap] > max)
        {
            max = DataManager.Instance.listUpgradeIncome[DataManager.Instance.listLevelEarning[3 * LoadingManager.Instance.currentMap]][3 * LoadingManager.Instance.currentMap];
        }
        if (DataManager.Instance.listOperatorUnlock[1 + 3 * LoadingManager.Instance.currentMap] == 1)
        {
            if (DataManager.Instance.listUpgradeIncome[DataManager.Instance.listLevelEarning[1 + 3 * LoadingManager.Instance.currentMap]][1 + 3 * LoadingManager.Instance.currentMap] > max)
            {
                max = DataManager.Instance.listUpgradeIncome[DataManager.Instance.listLevelEarning[1 + 3 * LoadingManager.Instance.currentMap]][1 + 3 * LoadingManager.Instance.currentMap];
            }
        }
        if (DataManager.Instance.listOperatorUnlock[2 + 3 * LoadingManager.Instance.currentMap] == 1)
        {
            if (DataManager.Instance.listUpgradeIncome[DataManager.Instance.listLevelEarning[2 + 3 * LoadingManager.Instance.currentMap]][2 + 3 * LoadingManager.Instance.currentMap] > max)
            {
                max = DataManager.Instance.listUpgradeIncome[DataManager.Instance.listLevelEarning[2 + 3 * LoadingManager.Instance.currentMap]][2 + 3 * LoadingManager.Instance.currentMap];
            }
        }
